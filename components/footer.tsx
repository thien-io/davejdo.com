      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-xs">
              Whether it&apos;s a project, collaboration, or just a chat — my inbox is always open.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-accent flex items-center justify-center group-hover:bg-foreground transition-colors duration-200">
                    <Icon size={14} className="text-muted-foreground group-hover:text-background transition-colors duration-200" />
                  </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-8 border-t border-border">
          ...
          <p className="text-xs font-mono text-muted-foreground">
            © {new Date().getFullYear()} davejdo.com — Built with Next.js
          </p>
        </div>
      </div>
    </footer>
